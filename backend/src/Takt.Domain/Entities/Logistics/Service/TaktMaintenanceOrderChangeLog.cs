...
//===================================================================
// 项目名 : Takt.Xp
// 文件名 : TaktMaintenanceOrderChangeLog.cs
// 创建者 : Takt(Claude AI)
// 创建时间: 2024-03-07
// 版本号 : V0.0.1
// 描述    : 维修工单变更记录实体类
...
namespace Takt.Domain.Entities.Logistics.Service
{
    ...
    /// </remarks>
    [SugarTable("Takt_logistics_maintenance_order_change_log", "维修工单变更记录表")]
    ...
    public class TaktMaintenanceOrderChangeLog : TaktBaseEntity
    {
