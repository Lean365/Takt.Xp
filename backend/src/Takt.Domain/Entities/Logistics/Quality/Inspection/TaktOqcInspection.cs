...
namespace Takt.Domain.Entities.Logistics.Quality.Inspection
{
    ...
    /// 出货检验（OQC）实体
    /// </summary>
    [SugarTable("Takt_logistics_quality_inspection_oqc", "出货检验(OQC)表")]
    [SugarIndex("ix_inspection_no", nameof(InspectionNo), OrderByType.Asc, false)]
    public class TaktOqcInspection : TaktBaseEntity
    {
        /// <summary>
        /// 检验单号
        /// </summary>
        ...
        /// 导航属性：检验明细列表
        /// </summary>
        [Navigate(NavigateType.OneToMany, nameof(TaktOqcInspectionDetail.InspectionNo), nameof(InspectionNo))]
        public List<TaktOqcInspectionDetail>? Details { get; set; }
