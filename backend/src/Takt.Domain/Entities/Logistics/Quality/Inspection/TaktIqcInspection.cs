...
namespace Takt.Domain.Entities.Logistics.Quality.Inspection
{
    ...
    /// 来料检验（IQC）实体
    /// </summary>
    [SugarTable("Takt_logistics_quality_inspection_iqc", "来料检验(IQC)表")]
    [SugarIndex("ix_inspection_no", nameof(InspectionNo), OrderByType.Asc, false)]
    public class TaktIqcInspection : TaktBaseEntity
    {
        /// <summary>
        /// 检验单号
        /// </summary>
        ...
        /// 导航属性：检验明细列表
        /// </summary>
        [Navigate(NavigateType.OneToMany, nameof(TaktIqcInspectionDetail.InspectionNo), nameof(InspectionNo))]
        public List<TaktIqcInspectionDetail>? Details { get; set; }
