...
namespace Takt.Domain.Entities.Logistics.Quality.Inspection
{
    ...
    /// 最终检验明细（FQC）实体
    /// </summary>
    [SugarTable("Takt_logistics_quality_inspection_fqc_detail", "最终检验明细(FQC)表")]
    [SugarIndex("ix_inspection_no", nameof(InspectionNo), OrderByType.Asc, false)]
    public class TaktFqcInspectionDetail : TaktBaseEntity
    {
        /// <summary>
        /// 检验单号（外键）
        /// </summary>
        ...
        /// 导航属性：关联主表
        /// </summary>
        [Navigate(NavigateType.ManyToOne, nameof(InspectionNo), nameof(TaktFqcInspection.InspectionNo))]
        public TaktFqcInspection? FqcInspection { get; set; }
