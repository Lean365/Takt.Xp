...
namespace Takt.Domain.Entities.Logistics.Quality.Inspection
{
    ...
    /// 过程检验（IPQC）实体
    /// </summary>
    [SugarTable("Takt_logistics_quality_inspection_ipqc", "过程检验(IPQC)表")]
    [SugarIndex("ix_inspection_no", nameof(InspectionNo), OrderByType.Asc, false)]
    public class TaktIpqcInspection : TaktBaseEntity
    {
        /// <summary>
        /// 检验单号
        /// </summary>
        ...
        /// 导航属性：检验明细列表
        /// </summary>
        [Navigate(NavigateType.OneToMany, nameof(TaktIpqcInspectionDetail.InspectionNo), nameof(InspectionNo))]
        public List<TaktIpqcInspectionDetail>? Details { get; set; }
