...
//===================================================================
// 项目名 : Takt.Xp
// 文件名 : TaktReworkCountermeasure.cs
// 创建者 : Takt(Claude AI)
// 创建时间: 2024-03-07
// 版本号 : V0.0.1
// 描述    : 对策成本实体类
...
namespace Takt.Domain.Entities.Logistics.Quality.Cost
{
    ...
    /// </remarks>
    [SugarTable("Takt_logistics_quality_business_rework_countermeasure", "对策成本表")]
    [SugarIndex("ix_quality_business_countermeasure", nameof(QualityBusinessId), OrderByType.Asc, false)]
    public class TaktReworkCountermeasure : TaktBaseEntity
    {
