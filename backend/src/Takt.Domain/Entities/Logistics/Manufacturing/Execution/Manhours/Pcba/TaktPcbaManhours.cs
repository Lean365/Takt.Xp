...
namespace Takt.Domain.Entities.Logistics.Manufacturing.Manhours.Pcba
{
    /// <summary>
    /// PCBA生产工数实体类
    /// </summary>
    ...
    /// </remarks>
    [SugarTable("Takt_logistics_execution_manhours_pcba", "PCBA生产工数表")]
    ...
    public class TaktPcbaManhours : TaktBaseEntity
    {
        /// <summary>
        /// 工厂代码
        /// </summary>
