...
namespace Takt.Domain.Entities.Logistics.Manufacturing.Outputs.Pcba
{
    ...
    /// 参考: PCBA手插管理
    /// </remarks>
    [SugarTable("Takt_logistics_execution_outputs_pcba_mir", "PCBA手插")]
    ...
    public class TaktPcbaMirOutput : TaktBaseEntity
    {
        /// <summary>
        /// 工厂代码
        /// </summary>
        ...
        /// PCBA手插明细列表
        /// </summary>
        [Navigate(NavigateType.OneToMany, nameof(TaktPcbaMirOutputDetail.PcbaMirOutputId))]
        public List<TaktPcbaMirOutputDetail>? PcbaMirOutputDetails { get; set; }
    }
}
