...
namespace Takt.Domain.Entities.Logistics.Manufacturing.Outputs.Pcba
{
    ...
    /// 参考: PCBA自插管理
    /// </remarks>
    [SugarTable("Takt_logistics_execution_outputs_pcba_ai", "PCBA自插")]
    ...
    public class TaktPcbaAiOutput : TaktBaseEntity
    {
        /// <summary>
        /// 工厂代码
        /// </summary>
        ...
        /// PCBA自插明细列表
        /// </summary>
        [Navigate(NavigateType.OneToMany, nameof(TaktPcbaAiOutputDetail.PcbaAiOutputId))]
        public List<TaktPcbaAiOutputDetail>? PcbaAiOutputDetails { get; set; }
    }
}
