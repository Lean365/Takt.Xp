...
//===================================================================
// 项目名 : Takt.Xp
// 文件名 : TaktPcbaEppSmtDailyDetail.cs
// 创建者 : Takt(Claude AI)
// 创建时间: 2024-03-07
// 版本号 : V0.0.1
// 描述    : PCBA SMT 明细实体类
...
namespace Takt.Domain.Entities.Logistics.Manufacturing.Outputs.Pcba
{
    ...
    /// 参考: PCBA SMT 明细管理
    /// </remarks>
    [SugarTable("Takt_logistics_execution_outputs_pcba_smt_detail", "PCBA SMT明细")]
    [SugarIndex("ix_pcba_smt_output_id", nameof(PcbaSmtOutputId), OrderByType.Asc, false)]
    public class TaktPcbaSmtOutputDetail : TaktBaseEntity
    {
        /// <summary>
        /// PCBA SMT EPP输出ID
        /// </summary>
        [SugarColumn(ColumnName = "pcba_smt_output_id", ColumnDescription = "PCBA SMT输出ID", ColumnDataType = "bigint", IsNullable = false)]
        public long PcbaSmtOutputId { get; set; }
        ...
        /// PCBA SMT 
        /// </summary>
        [Navigate(NavigateType.OneToOne, nameof(PcbaSmtOutputId))]
        public TaktPcbaSmtOutput? PcbaSmtOutput { get; set; }
    }
}
