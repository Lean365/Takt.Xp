...
namespace Takt.Domain.Entities.Logistics.Manufacturing.Outputs.Pcba
{
    ...
    /// 参考: PCBA手插明细管理
    /// </remarks>
    [SugarTable("Takt_logistics_execution_outputs_pcba_mir_detail", "PCBA手插明细")]
    [SugarIndex("ix_pcba_mir_output_id", nameof(PcbaMirOutputId), OrderByType.Asc, false)]
    public class TaktPcbaMirOutputDetail : TaktBaseEntity
    {
        /// <summary>
        /// PCBA手插ID
        /// </summary>
        [SugarColumn(ColumnName = "pcba_mir_output_id", ColumnDescription = "PCBA手插ID", ColumnDataType = "bigint", IsNullable = false)]
        public long PcbaMirOutputId { get; set; }
        ...
        /// PCBA手插
        /// </summary>
        [Navigate(NavigateType.OneToOne, nameof(PcbaMirOutputId))]
        public TaktPcbaMirOutput? PcbaMirOutput { get; set; }
    }
}
