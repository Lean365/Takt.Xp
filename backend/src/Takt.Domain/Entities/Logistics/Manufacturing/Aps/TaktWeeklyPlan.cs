...
//===================================================================
// 项目名 : Takt.Xp
// 文件名 : TaktWeeklyManufacturingPlan.cs
// 创建者 : Takt(Claude AI)
// 创建时间: 2024-03-07
// 版本号 : V0.0.1
// 描述    : 周生产计划实体类 (Weekly Manufacturing Plan)
...
{
    /// <summary>
    /// 周生产计划实体类 (Weekly Manufacturing Plan)
    /// </summary>
    /// <remarks>
    /// 创建者:Takt(Claude AI)
    /// 创建时间: 2024-03-07
    /// 参考: SAP PP 生产计划模块
    /// </remarks>
    [SugarTable("Takt_logistics_manufacturing_aps_weekly_plan", "周生产计划表")]
    [SugarIndex("ix_weekly_plan_code", nameof(WeeklyPlanCode), OrderByType.Asc, true)]
    ...
    [SugarIndex("ix_week_start_date", nameof(WeekStartDate), OrderByType.Desc, false)]
    public class TaktWeeklyPlan : TaktBaseEntity
    {
        /// <summary>
        /// 工厂代码
        /// </summary>
