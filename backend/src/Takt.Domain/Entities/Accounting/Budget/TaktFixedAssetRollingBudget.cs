...
//===================================================================
// 项目名 : Takt.Xp
// 文件名 : TaktFixedAssetRollingBudget.cs
// 创建者 : Takt(Claude AI)
// 创建时间: 2024-03-07
// 版本号 : V0.0.1
...
namespace Takt.Domain.Entities.Accounting.Budget
{
    ...
    /// 参考: SAP FI-AA 固定资产管理
    /// </remarks>
    [SugarTable("Takt_accounting_budget_fixed_asset_rolling_budget", "固资滚动")]
    ...
    public class TaktFixedAssetRollingBudget : TaktBaseEntity
    {
        /// <summary>
        /// 公司代码
        /// </summary>
