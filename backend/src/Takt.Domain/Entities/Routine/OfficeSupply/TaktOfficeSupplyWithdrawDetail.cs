...
//===================================================================
// 项目名 : Takt.Xp
// 文件名 : TaktOfficeSupplyWithdrawDetail.cs
// 创建者 : Takt(Claude AI)
// 创建时间: 2024-12-01
// 版本号 : V0.0.1
// 描述    : 办公用品领用申请明细表实体类
...
namespace Takt.Domain.Entities.Routine.OfficeSupply
{
    ...
    /// </remarks>
    [SugarTable("Takt_routine_office_supply_withdraw_detail", "办公用品领用申请明细")]
    ...
    public class TaktOfficeSupplyWithdrawDetail : TaktBaseEntity
    {
